...
2. The bottom dock stays short. Next to the brick picker, choose **Color** or **Sticker** — only that panel opens underneath. Color shows eight bright and pastel swatches. Sticker shows **Faces** (Plain, Smile, Grin, Wink, Sleepy, Wow, Shy, Kitty, Puppy), **Numbers** (0–10), or **Letters** (A–Z), plus Plain to clear a sticker. Prints sit on the front of a **2×2 brick** only, so the picture is never stretched across a longer piece. Any other brick, plate, or special hides the sticker choices and shows “Faces fit 2×2 bricks”. A saved print on a non-2×2 piece loads as Plain.
