...
Bricks use **Duplo-compatible proportions** (about 2× System scale: 16-unit stud pitch, brick height 19.2, plates at half a brick so two plates equal one brick, hollow studs). Special pieces follow real part proportions: a 2×4×2 inside-bow arch, a 3×2 gentle slope, and a 2×2×2 round cylinder with four studs. Geometry is procedural Three.js — no STL or official brick assets.
...
1. Choose a brick from the compact picker (tap to open the dropdown). The kit includes:
   ...
   - Specials: **2×4×2 arch** (bridge arch), **3×2 slope** (gentle ramp), **2×2×2 round** (tall cylinder)
